...
var voornaam = "Demi"; // wijzig dit in jouw eigen voornaam
var tussenvoegsel = "D"; // wijzig dit in jouw eigen eventuele tussenvoegsel
var achternaam = "Fahmi"; // wijzig dit in jouw eigen achternaam
var volledigeNaam = "Demi D. Fahmi"; // plak hier de 3 bovenstaande variabelen aan elkaar, met spaties
var geboortedag = "Zaterdag"; // je geboortedag
var geboortemaand = "December"; // je geboortemaand
...
var dag_van_het_jaar = 5; // bereken hier hoeveelste dag van dit kalenderjaar het is
var straat = "Zwanenkamp"; // je straat;
var huisnummer = "1118"; // je huisnummer;
var woonplaats = "Maarssen"; // je woonplaats;
var woonachtig_in_utrecht = "true";// check hier dmv een boolean of jouw woonplaats gelijk is aan "Utrecht"
var aantal_studenten_in_deze_klas = 0;
...
document.write("<br>");
document.write("Woonachtig in Utrecht: " + woonachtig_in_utrecht);
document.write("<br>");
document.write("Aantal studenten in deze klas: " + aantal_studenten_in_deze_klas);
document.write("<br>");
document.write("Kosten van frikandelbroodje: " + kosten_van_frikandelbroodje);
document.write("<br>");
document.write("Totale lunchkosten: " + totale_lunchkosten);
